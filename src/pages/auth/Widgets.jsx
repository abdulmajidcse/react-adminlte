...
export default function Widgets() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">Widgets</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
              { text: "Widgets", active: true },
            ]}
          />
        }
      >
            ...
            <div className="col-md-4">
              ...
              <div className="card card-widget widget-user">
                ...
                <div
                  ...
                  style={{
                    background: `url(${image7}) center center`,
                  }}
                >
                ...
                <div className="widget-user-image">
                  <img className="img-circle" src={image4} alt="User Avatar" />
                </div>
                <div className="card-footer">
                  <div className="row">
                    <div className="col-sm-4 border-right">
              ...
              <div className="card card-widget">
                <div className="card-header">
                  <div className="user-block">
                    <img className="img-circle" src={image3} alt="User" />
                ...
                {/* /.card-header */}
                <div className="card-body">
                  <img className="img-fluid pad" src={image6} alt="" />
              ...
              <div className="row">
                <div className="col-md-12 col-lg-6 col-xl-4">
                  <div className="card mb-2 bg-gradient-dark">
                    <img className="card-img-top" src={image7} alt="Dist" />
                ...
                <div className="col-md-12 col-lg-6 col-xl-4">
                  <div className="card mb-2">
                    <img className="card-img-top" src={image6} alt="Dist" />

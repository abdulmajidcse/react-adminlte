...
export default function Ecommerce() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">E-commerce</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
            ...
            <div className="row">
              <div className="col-12 col-sm-6">
                ...
                <div className="col-12">
                  <img
                    src={require("./../../../assets/dist/img/prod-1.jpg")}
                ...
                <div className="col-12 product-image-thumbs">
                  ...
                  <div className="product-image-thumb">
                    <img
                      src={require("./../../../assets/dist/img/prod-2.jpg")}
                      alt="Product"
                    />
                  </div>
                  <div className="product-image-thumb">
                    <img
                      src={require("./../../../assets/dist/img/prod-3.jpg")}
                      alt="Product"
                    />
                  </div>
                  <div className="product-image-thumb">
                    <img
                      src={require("./../../../assets/dist/img/prod-4.jpg")}
                      alt="Product"
                    />
                  </div>
                  <div className="product-image-thumb">
                    <img
                      src={require("./../../../assets/dist/img/prod-5.jpg")}
                      alt="Product"
                    />
                  </div>
                </div>

                    ...
                    <ul className="list-inline">
                      <li className="list-inline-item">
                        <img
                          ...
                          src={require("./../../../../assets/dist/img/avatar.png")}
                        />
                      </li>
                      <li className="list-inline-item">
                        <img
                          alt="Avatar"
                          className="table-avatar"
                          src={require("./../../../../assets/dist/img/avatar2.png")}
                        />
                      </li>
                      <li className="list-inline-item">
                        <img
                          alt="Avatar"
                          className="table-avatar"
                          src={require("./../../../../assets/dist/img/avatar3.png")}
                        />
                      </li>
                      <li className="list-inline-item">
                        <img
                          alt="Avatar"
                          className="table-avatar"
                          src={require("./../../../../assets/dist/img/avatar4.png")}
                        />
                      </li>
                    </ul>
                  </td>
                    ...
                    <ul className="list-inline">
                      ...
                      <li className="list-inline-item">
                        <img
                          alt="Avatar"
                          className="table-avatar"
                          src={require("./../../../../assets/dist/img/avatar5.png")}
                        />
                      </li>
                    </ul>
                  </td>

...
export default function Invoice() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">Invoice</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
            ...
            <div className="invoice p-3 mb-3">
              ...
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <img
                    src={require("./../../../assets/dist/img/credit/visa.png")}
                    alt="Visa"
                  />
                  <img
                    src={require("./../../../assets/dist/img/credit/mastercard.png")}
                    alt="Mastercard"
                  />
                  <img
                    src={require("./../../../assets/dist/img/credit/american-express.png")}
                    alt="American Express"
                  />
                  <img
                    src={require("./../../../assets/dist/img/credit/paypal2.png")}
                    alt="Paypal"
                  />
                  <p
              ...
              <div className="row no-print">
                <div className="col-12">
                  <a href="#" rel="noopener" className="btn btn-default">

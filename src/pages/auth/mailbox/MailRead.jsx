...
export default function MailRead() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">Compose</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
              { text: "Compose", active: true },
            ]}
          />
        }
      >
        <div className="row">
          <div className="col-md-3">
            <Link to="/auth/mailbox" className="btn btn-primary btn-block mb-3">
              Back to Inbox
            </Link>
            <div className="card">
              ...
              <div className="card-body p-0">
                ...
                <div className="mailbox-read-message">
                  ...
                  <p>
                    ...
                    pack gluten-free. Marfa butcher vegan quinoa, bicycle rights
                    disrupt tofu scenester chillwave 3 wolf moon asymmetrical
                    taxidermy pour-over. Quinoa tote bag fashion axe, Godard
                    disrupt migas church-key tofu blog locavore. Thundercats
                    cronut polaroid Neutra tousled, meh food truck selfies
                    narwhal American Apparel.
                  </p>
                  <p>
                    ...
                    gluten-free health goth umami hoodie. Synth Echo Park
                    bicycle rights DIY farm-to-table, retro kogi sriracha
                    dreamcatcher PBR&amp;B flannel hashtag irony Wes Anderson.
                    Lumbersexual Williamsburg Helvetica next level. Cold-pressed
                    slow-carb pop-up normcore Thundercats Portland, cardigan
                    literally meditation lumbersexual crucifix. Wayfarers raw
                    denim paleo Bushwick, keytar Helvetica scenester keffiyeh
                    8-bit irony mumblecore whatever viral Truffaut.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    Apparel twee. American Apparel PBR listicle, salvia
                    aesthetic occupy sustainable Neutra kogi. Organic synth
                    Tumblr viral plaid, shabby chic single-origin coffee Etsy 3
                    wolf moon slow-carb Schlitz roof party tousled squid vinyl.
                    Readymade next level literally trust fund. Distillery master
                    cleanse migas, Vice sriracha flannel chambray chia cronut.
                  </p>
                  <p>
                    Thanks,
                    <br />

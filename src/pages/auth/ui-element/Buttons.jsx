...
export default function Buttons() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">Buttons</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
              { text: "Buttons", active: true },
            ]}
          />
        }
      >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-default disabled"
                          >
                            Default
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-secondary btn-flat"
                          >
                            Secondary
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-success btn-flat"
                          >
                            Success
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-info btn-xs"
                          >
                            Info
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-info btn-flat"
                          >
                            Info
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-info disabled"
                          >
                            Info
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-danger btn-flat"
                          >
                            Danger
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-danger disabled"
                          >
                            Danger
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-warning disabled"
                          >
                            Warning
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-light btn-lg"
                          >
                            Light
                          </button>
                        </td>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-light btn-xs"
                          >
                            Light
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-light btn-flat"
                          >
                            Light
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-dark btn-flat"
                          >
                            Dark
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-dark disabled"
                          >
                            Dark
                          </button>
                        </td>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-light btn-lg"
                          >
                            Light
                          </button>
                        </td>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-light btn-xs"
                          >
                            Light
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-light btn-flat"
                          >
                            Light
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-light disabled"
                          >
                            Light
                          </button>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-dark btn-flat"
                          >
                            Dark
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block btn-outline-dark disabled"
                          >
                            Dark
                          </button>
                        </td>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block bg-gradient-secondary"
                          >
                            Secondary
                          </button>
                        </td>
                      ...
                      <tr>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block bg-gradient-info"
                          >
                            Info
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block bg-gradient-info btn-lg"
                          >
                            Info
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block bg-gradient-info btn-sm"
                          >
                            Info
                          </button>
                        </td>
                        <td>
                          <button
                            type="button"
                            className="btn btn-block bg-gradient-info btn-xs"
                          >
                            Info
                          </button>
                        </td>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div className="card">
                ...
                <div className="card-body table-responsive pad">
                  <p>
                    Vertical button groups are easy to create with bootstrap.
                    Just add your buttons inside{" "}
                    <code>

...
import "./../../../assets/css/ui-general.css";
...
export default function General() {
  ...
  return (
    <>
      <AuthCard
        leftHeader={<h1 className="m-0">Inline Charts</h1>}
        rightHeader={
          <Breadcrumb
            items={[
              { text: "Home", path: "/auth" },
              { text: "Inline Charts", active: true },
            ]}
          />
        }
      >
              ...
              <div className="card card-default">
                ...
                <div className="card-body">
                  <div className="callout callout-danger">
                    ...
                    <p>
                      There is a problem that we need to fix. A wonderful
                      serenity has taken possession of my entire soul, like
                ...
                <div className="card-body">
                  <div className="tab-content">
                    <div className="tab-pane active" id="tab_1">
                      ...
                      moment; and yet I feel that I never was a greater artist
                      than now.
                    </div>
                    {/* /.tab-pane */}
                    <div className="tab-pane" id="tab_2">
                      ...
                      common language would be desirable: one could refuse to
                      pay expensive translators. To achieve this, it would be
